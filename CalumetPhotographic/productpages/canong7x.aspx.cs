...
public partial class productpages_canong7x : System.Web.UI.Page
{
    ...
    protected void btnCanong7x_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(549.00);
        cartItem.setItemName("Canon G7 X Mark II");
    ...
    protected void rblG7x_SelectedIndexChanged(object sender, EventArgs e)
    {
        int selectedValue = Int32.Parse(rblG7x.SelectedValue);
        if (selectedValue == 1)
        {
            this.imgCanong7xfront.ImageUrl = "~/images/cameras/canong7xfront.jpg";
        }
        else
        {
            this.imgCanong7xfront.ImageUrl = "~/images/cameras/canong7xtop.jpg";
        }
    }
}