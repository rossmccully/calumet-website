...
public partial class productpages_nikond3300 : System.Web.UI.Page
{
    ...
    protected void btnNikond3300_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(369.00);
        cartItem.setItemName("Nikon D3300");
    ...
    protected void rbl3300_SelectedIndexChanged(object sender, EventArgs e)
    {
        int selectedValue = Int32.Parse(rbl3300.SelectedValue);
        if (selectedValue == 1)
        {
            this.img3300.ImageUrl = "~/images/cameras/canon5dmk4front.jpg";
        }
        else
        {
            this.img3300.ImageUrl = "~/images/cameras/canon5dmk4back.jpg";
        }
    }
}