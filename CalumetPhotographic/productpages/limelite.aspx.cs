...
public partial class productpages_limelite : System.Web.UI.Page
{
    ...
    protected void btnLimelite_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(399.00);
        cartItem.setItemName("Limelite Mosaic 2 - 30x30 Daylight LED Panel");
