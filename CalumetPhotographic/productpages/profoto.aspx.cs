...
public partial class productpages_profoto : System.Web.UI.Page
{
    ...
    protected void btnProfoto_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(320.00);
        cartItem.setItemName("Profoto Air Remote TTL-C (Canon)");
