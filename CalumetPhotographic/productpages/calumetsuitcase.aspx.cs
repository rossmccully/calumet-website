...
public partial class productpages_calumetsuitcase : System.Web.UI.Page
{
    ...
    protected void btnCalumetsuitcase_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(169.00);
        cartItem.setItemName("Calumet RC2065 Rolling Camera Case Plus");
