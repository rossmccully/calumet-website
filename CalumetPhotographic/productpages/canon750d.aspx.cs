...
public partial class productpages_canon750d : System.Web.UI.Page
{
    ...
    protected void btnCanon750d_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(649.00);
        cartItem.setItemName("Canon 750D + 18-55mm IS STM Lens");
