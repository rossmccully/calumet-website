...
public partial class productpages_calumetcase : System.Web.UI.Page
{
    ...
    protected void btnCalumetcase_Click(object sender, EventArgs e)
    {
        CartItem cartItem = new CartItem();
        cartItem.setCost(39.00);
        cartItem.setItemName("Calumet Inserts for Rolling Camera Case");
