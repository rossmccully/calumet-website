...
public partial class productpages_nikond810 : System.Web.UI.Page
{
    ...
    protected void btnNikond810_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(2399.00);
        cartItem.setItemName("Nikon D810");
    ...
    protected void rbl810_SelectedIndexChanged(object sender, EventArgs e)
    {
        int selectedValue = Int32.Parse(rbl810.SelectedValue);
        if (selectedValue == 1)
        {
            this.img810.ImageUrl = "~/images/cameras/nikond810front.jpg";
        }
        else
        {
            this.img810.ImageUrl = "~/images/cameras/nikond810back.jpg";
        }
    }
}