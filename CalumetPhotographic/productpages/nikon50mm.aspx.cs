...
public partial class productpages_nikon50mm : System.Web.UI.Page
{
    ...
    protected void btnNikon50mm_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(385.00);
        cartItem.setItemName("Nikon 50mm f/1.4G AF-S");
