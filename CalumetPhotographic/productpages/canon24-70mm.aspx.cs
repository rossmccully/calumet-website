...
public partial class productpages_canon24_70mm : System.Web.UI.Page
{
    ...
    protected void btnCanon2470mm_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(1899.00);
        cartItem.setItemName("Canon EF 24-70mm f/2.8L II USM");
