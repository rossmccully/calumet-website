...
public partial class productpages_NikonD7200 : System.Web.UI.Page
{
    ...
    protected void btnNikond7200_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(1099.00);
        cartItem.setItemName("Nikon D7200");
