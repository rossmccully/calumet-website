...
public partial class productpages_canon5d : System.Web.UI.Page
{
    ...
    protected void btnCanon5d_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(3499.00);
        cartItem.setItemName("Canon 5D Mark IV");
    ...
    protected void rblCanon5d_SelectedIndexChanged(object sender, EventArgs e)
    {
        int selectedValue = Int32.Parse(rblCanon5d.SelectedValue);
        if (selectedValue == 1)
        {
            this.imgCanon5d.ImageUrl = "~/images/cameras/canon5dmk4front.jpg";
        }
        else
        {
            this.imgCanon5d.ImageUrl = "~/images/cameras/canon5dmk4back.jpg";
        }
