...
public partial class productpages_stand3 : System.Web.UI.Page
{
    ...
    protected void btnStand3_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(37.00);
        cartItem.setItemName("Calumet Ultra Compact Stand");
