...
public partial class productpages_extreme32gb : System.Web.UI.Page
{
    ...
    protected void btnExtreme32gb_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(34.00);
        cartItem.setItemName("SanDisk 32GB Extreme Pro SDHC UHS-I Memory Card");
