...
public partial class productpages_blackmagic : System.Web.UI.Page
{
    ...
    protected void btnBlackmagic_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(2640.00);
        cartItem.setItemName("Blackmagic Cinema Camera 4k - EF Mount");
