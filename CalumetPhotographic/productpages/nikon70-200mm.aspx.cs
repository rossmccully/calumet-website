...
public partial class productpages_nikon70_200mm : System.Web.UI.Page
{
    ...
    protected void btnNikon70200mm_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(1999.00);
        cartItem.setItemName("Nikon 70-200mm f/2.8 AF-S ED VR II");
