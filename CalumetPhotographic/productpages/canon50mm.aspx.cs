...
public partial class productpages_canon50mm : System.Web.UI.Page
{
    ...
    protected void btnCanon50mm_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(106.00);
        cartItem.setItemName("Canon EF 50mm f/1.8 STM");
