...
public partial class productpages_stand1 : System.Web.UI.Page
{
    ...
    protected void btnStand2_Click(object sender, EventArgs e)
    {
        Trace.Warn("Adding an item to the cart");
        // create cart item object with the product details
        CartItem cartItem = new CartItem();
        cartItem.setCost(62.00);
        cartItem.setItemName("Calumet 13.5' (4.1m) Air-Cushioned Light Stand");
